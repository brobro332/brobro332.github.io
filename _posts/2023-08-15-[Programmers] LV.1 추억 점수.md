...
시간 복잡도 기준도 널널하고 구현 로직도 단순해서 LV.1에 걸맞는 난이도였다. <br><br>

이중 for문이나 index 함수를 사용해도 문제 없을 것 같으나, <br>
딕셔너리를 이용해서 시간 복잡도를 최대한 빠르게 구현해보았다. <br><br>

이번 문제는 쉬워서 새롭게 배운 점은 없는 것 같다.
